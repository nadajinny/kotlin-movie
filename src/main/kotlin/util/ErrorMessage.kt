...
object ErrorMessage {
    ...
    const val SHOWING_NOT_FOUND_FOR_DATE = "해당 날짜에 선택한 영화의 상영이 없습니다."
    const val INVALID_SHOWING_NUMBER = "선택하신 상영 번호는 없는 상영 번호입니다."
    const val OVERLAPPING_SHOWING = "선택하신 상영 시간이 겹칩니다. 다른 시간을 선택해 주세요."
    ...
    const val ID_MUST_BE_POSITIVE = "ID는 양수이어야 합니다."
